...
const PAGE_META: Record<string, { title: string; subtitle: string }> = {
  ...
  '/databasestakeholder': { title: 'Relasi & Bantuan',  subtitle: 'Basis data komprehensif donatur, relawan, dan penerima bantuan.' },
  '/messages':      { title: 'Kotak Masuk',           subtitle: 'Tinjau pesan kolaborasi dan laporan dari pendukung.' },
  '/gallery':       { title: 'Galeri Aktivitas',     subtitle: 'Kelola dokumentasi visual kegiatan dan bukti penyaluran.' },
